...
$(function() {
	...
	// for some reason on heroku, it currently says that getCurrentPosition function has been deprecated
	var getCurrentPositionWorks = false;
	...
	// Geolocation
	if (getCurrentPositionWorks === true) {
